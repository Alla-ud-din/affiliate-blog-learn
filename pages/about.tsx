...
export default function About() {
  return (
    <>
      <SEO
        title="About"
        description="Learn about Luxe Living Corners — our mission, how we test products, and our commitment to honest recommendations."
        image="/og-image.jpg"
      />
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-8 space-y-5 font-body text-neutral-600 leading-relaxed">
          <p>
            Luxe Living Corners was started by a small team of product enthusiasts who got tired of reading reviews
          ...
          <p>
            Luxe Living Corners participates in the Amazon Associates program. When you click a link and make a purchase,
