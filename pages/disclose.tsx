...
export default function Disclose() {
  return (
    <>
      <SEO title="Affiliate Disclosure" description="Our affiliate disclosure and how we earn commissions." noindex />
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="font-body text-neutral-600 space-y-4 leading-relaxed">
          <p>
            GoodFinds is a participant in the Amazon Services LLC Associates Program, an affiliate advertising
